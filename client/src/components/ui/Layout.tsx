  ...
  if (variant === "patient") {
    ...
    return (
      <div className="min-h-screen bg-background text-foreground patient-mode transition-colors duration-300">
        <header className="p-6 border-b-4 border-primary/30 flex items-center justify-between bg-secondary">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center text-primary-foreground font-bold text-3xl">
          ...
          <button 
            ...
            className="px-8 py-4 bg-muted border-2 border-muted-foreground text-foreground text-xl font-bold rounded-xl hover:bg-muted/80"
          >
            Sign Out
          </button>
        </header>
